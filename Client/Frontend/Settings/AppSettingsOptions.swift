...
class OpenSupportPageSetting: Setting {
    ...
    override func onClick(_ navigationController: UINavigationController?) {
        navigationController?.dismiss(animated: true) {
            if let url = URL(string: NSLocalizedString("settings.help.url", value: "https://help.qwant.com/help/qwant-mobile/?client=qwantjuniorbrowser", comment: "Help URL. See https://help.qwant.com/help/qwant-mobile/")) {
...
class PrivacyPolicySetting: Setting {
    ...
    override var url: URL? {
        return URL(string: NSLocalizedString("settings.privacypolicy.url", value: "https://about.qwant.com/legal/privacy/?client=qwantjuniorbrowser", comment: "Privacy policy URL. See https://about.qwant.com/legal/privacy/"))
    }
